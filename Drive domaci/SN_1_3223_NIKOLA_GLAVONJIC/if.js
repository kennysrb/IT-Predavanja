...
if (kraj1 < pocetak2) {
  ...
  if (pocetak1 >= pocetak2 && kraj1 <= kraj2) {
    document.body.innerHTML += `<h2>3. Vreme koje su dva lekara provela zajedno na poslu je: ${time_convert(kraj1 - pocetak1)}</h2>`;
  } else if (pocetak2 >= pocetak1 && kraj2 <= kraj1) {
    document.body.innerHTML += `<h2>4. Vreme koje su dva lekara provela zajedno na poslu je: ${time_convert(kraj2 - pocetak2)}</h2>`;
  } else if (kraj1 > pocetak2 && pocetak1 > pocetak2 && kraj2 > pocetak1 && kraj2 <= kraj1) {
    document.body.innerHTML += `<h2>5. Vreme koje su dva lekara provela zajedno na poslu je: ${time_convert(kraj2 - pocetak1)}</h2>`;
  } else if (kraj2 > pocetak1 && pocetak2 > pocetak1 && kraj1 > pocetak2 && kraj1 <= kraj2) {
    document.body.innerHTML += `<h2>6. Vreme koje su dva lekara provela zajedno na poslu je: ${time_convert( kraj1 - pocetak2)}</h2>`;
  } else {
